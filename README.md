...
5. Запустите нужный файл:
   - Для быстрой установки запустите **`easy-install.bat`** от имени администратора.
   - Для ручной установки и настройки используйте **`service.bat`**.
   - Для разового запуска без установки используйте **`general*.bat`**.
   (Подробнее см. раздел [Краткие описания файлов](#ℹ️краткие-описания-файлов) и файл [**`instruction.md`**](./instruction.md))

## ℹ️Краткие описания файлов

- [**`easy-install.bat`**](./easy-install.bat) / [**`auto-install.bat`**](./auto-install.bat) - скрипты для быстрой установки в автозапуск. Подробнее читайте в [**`instruction.md`**](./instruction.md).
